...
app.get('/flag', (req, res) => {
    ...
    console.log('hash: ', hash(`${req.connection.remoteAddress}${req.query.token}`))
    console.log('userData.token: ', userData.token)

    console.log('hash(""): ', hash(``))
    console.log('ok?', ( req.query.token.match(/[0-9a-f]{16}/)))
    console.log('ok?', (req.query.token && req.query.token.match(/[0-9a-f]{16}/)) == true)
